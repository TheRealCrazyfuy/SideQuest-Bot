...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!channel || !channel.isTextBased()) {
            return interaction.reply({ content: 'Can not find the reaction roles channel smh.', ephemeral: true });
        }
		...
		await channel.send({ content: `Please take your cosmetic Roles here.
